...
app = FastAPI(
    ...
    description="A production-grade multi-document RAG chatbot — upload PDFs, DOCX, or TXT files and chat with them using LangChain + FAISS + Google Gemini. Deployed on AWS ECS Fargate.",
    version="1.0.0",
    contact={"name": "Vikash", "url": "https://github.com/vikash"},
)
